/* webgpu-utils@0.8.0, license MIT */
...
function normalizeArray(srcMin, srcMax, dstMin, dstMax, array) {
 ...
 * @param options
 */
function createBufferInfoFromArrays(device, arrays, options = {}) {
    const stepMode = options.stepMode || 'vertex';
    options.interleave === undefined ? true : options.interleave;
...
export { TypedArrayViewGenerator, copySourceToTexture, copySourcesToTexture, createBufferInfoFromArrays, createTextureFromImage, createTextureFromImages, createTextureFromSource, createTextureFromSources, generateMipmap, getSizeForMipFromTexture, getSizeFromSource, isTypedArray, loadImageBitmap, makeShaderDataDefinitions, makeStructuredView, makeTypedArrayViews, normalizeArray, normalizeGPUExtent3D, numMipLevels, setStructuredValues, setStructuredView };
